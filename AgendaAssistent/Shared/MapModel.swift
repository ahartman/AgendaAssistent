...
class MapModel {
    ...
    func getPins(patients: [PatientInfo]) -> [PatientMap.Marker] {
        let rodeweg = PatientMap.Marker(coordinate: thuis, radius: 0.0, color: .yellow, monogram: "", name: "Praktijk")
        ...
        for patient in patients {
            ...
            localPins.append(PatientMap.Marker(coordinate: patientLocation.coordinate, radius: mapCircle!.radius, color: mapCircle!.strokeColor, monogram: monogram, name: patient.patientName))
        }
